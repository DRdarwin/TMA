...
const getUserSettings = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const settings = yield db_1.default.userSettings.findUnique({
        where: { userId },
    });
    if (!settings) {
...
const updateUserSettings = (userId, settingsData) => __awaiter(void 0, void 0, void 0, function* () {
    return yield db_1.default.userSettings.upsert({
        where: { userId },
        update: settingsData,
        create: Object.assign(Object.assign({}, settingsData), { userId }),
    });
});
